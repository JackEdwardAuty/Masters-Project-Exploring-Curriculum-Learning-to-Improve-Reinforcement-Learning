...
% ------------------------------------------------------------------------------
\chapter{Example} % enter the name of the chapter here
\label{cha:chapter label} % enter the chapter label here (for cross referencing)

\blindtext[1] % Creates 

\section{Introduction} % enter the name of the section here
...
% ------------------------------------------------------------------------------
\section{Referencing}
References can be cited so that the author names(s) are a part of the sentence, e.g

Alternatively, references can be cited so that the author names appear in the brackets (for when the name of the author is not relevant to the sentence), e.g.,

Since we use IEEE reference, the in-text citations numbers start at [1] and continue in ascending order throughout the paper.
To do a citation, e.g \cite{misc01}. you can change the name of the label in the references.bib  
